  ...
  methods: {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 1:
              ...
              _context.n = 2;
              return Promise.all([_this.loadSummary(), _this.loadTopProducts(), _this.loadRecentSales(), _this.loadSales(1)]);
            case 2:
            ...
            case 3:
              _context.p = 3;
              _t = _context.v;
              console.error('Failed to load reports:', _t);
    ...
    loadSummary: function loadSummary() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var params, res, salesData, totalSales, totalRevenue, totalItems, avgSale, _t2;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            ...
            case 1:
              ...
              totalSales = parseInt(salesData.paid_count) || 0;
              totalRevenue = parseFloat(salesData.paid_total) || 0;
              totalItems = parseInt(salesData.paid_items_count) || 0;
    ...
    loadTopProducts: function loadTopProducts() {
      var _this4 = this;
        ...
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              _context4.p = 0;
              params = {
                from_date: _this4.filters.from_date,
                to_date: _this4.filters.to_date,
                limit: 5
              };
              _context4.n = 1;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/reports/top-products', {
                params: params
              });
            case 1:
              res = _context4.v;
              // Ensure data is properly formatted with numeric values
              _this4.topProducts = (res.data.data || []).map(function (item) {
                return {
                  name: item.name || '',
            ...
            case 2:
              _context4.p = 2;
              _t3 = _context4.v;
              console.error('Failed to load top products:', _t3);
              _this4.topProducts = [];
            case 3:
    ...
    loadRecentSales: function loadRecentSales() {
      var _this5 = this;
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.p = _context5.n) {
            case 0:
              _context5.p = 0;
              params = {
                from_date: _this5.filters.from_date,
                to_date: _this5.filters.to_date,
                limit: 5
              };
              _context5.n = 1;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/reports/recent-sales', {
                params: params
              });
            case 1:
              res = _context5.v;
              // Ensure data is properly formatted with numeric values
              _this5.recentSales = (res.data.data || []).map(function (item) {
                return {
                  id: item.id || 0,
            ...
            case 2:
              _context5.p = 2;
              _t4 = _context5.v;
              console.error('Failed to load recent sales:', _t4);
              _this5.recentSales = [];
            case 3:
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.p = _context6.n) {
            case 0:
              ...
              params = {
                page: page,
                from_date: _this6.filters.from_date,
                to_date: _this6.filters.to_date
              };
              _context6.n = 2;
            ...
            case 2:
              ...
              if (res.data && res.data.data) {
                res.data.data = res.data.data.map(function (sale) {
                  return _objectSpread(_objectSpread({}, sale), {}, {
                    total: parseFloat(sale.total) || 0
                  });
                });
              }
              _this6.sales = res.data;
              _context6.n = 4;
              break;
            case 3:
              _context6.p = 3;
              _t5 = _context6.v;
              console.error('Failed to load sales:', _t5);
              _this6.sales = {
                data: [],
                total: 0,
                per_page: 15,
        ...
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.p = _context7.n) {
            ...
            case 2:
              ...
              if (_this7.$refs.salesByDayChart) {
                console.log('Creating sales by day chart...');
                _this7.charts.salesByDay = new chart_js_auto__WEBPACK_IMPORTED_MODULE_2__["default"](_this7.$refs.salesByDayChart.getContext('2d'), {
                  type: 'bar',
                  data: {
            ...
            case 3:
              _context7.p = 3;
              _t6 = _context7.v;
              console.error('Failed to update sales by day chart:', _t6);
            case 4:
              return _context7.a(2);
          }
        }, _callee7, null, [[0, 3]]);
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
        ...
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.p = _context8.n) {
            case 0:
              _context8.p = 0;
              if (!_this8.charts.salesByCategory) {
                _context8.n = 1;
                break;
              }
            ...
            case 2:
              ...
              if (_this8.$refs.salesByCategoryChart) {
                console.log('Creating sales by category chart...');
                _this8.charts.salesByCategory = new chart_js_auto__WEBPACK_IMPORTED_MODULE_2__["default"](_this8.$refs.salesByCategoryChart.getContext('2d'), {
                  type: 'pie',
                  data: {
            ...
            case 3:
              _context8.p = 3;
              _t7 = _context8.v;
              console.error('Failed to update sales by category chart:', _t7);
            case 4:
              return _context8.a(2);
          }
        }, _callee8, null, [[0, 3]]);
        ...
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.p = _context9.n) {
            ...
            case 1:
              ...
              _this9.$bvModal.show('sale-details-modal');
              _context9.n = 3;
              break;
            case 2:
              _context9.p = 2;
              _t8 = _context9.v;
              console.error('Failed to load sale details:', _t8);
              sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                icon: 'error',
                title: 'Error',
    ...
    printReceipt: function printReceipt(sale) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
        var res, saleDetails, formattedSale, receiptHtml, _t9;
        return _regenerator().w(function (_context0) {
          while (1) switch (_context0.p = _context0.n) {
            ...
            case 1:
              ...
              receiptHtml = _this0.generateReceiptHtml(formattedSale);
              _this0.openPrintWindow(receiptHtml);
              sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                icon: 'success',
            ...
            case 2:
              _context0.p = 2;
              _t9 = _context0.v;
              console.error('Failed to print receipt:', _t9);
              sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                icon: 'error',
                title: 'Print Failed',
        ...
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.p = _context1.n) {
            ...
            case 1:
              ...
              link.href = url;
              link.setAttribute('download', "sales-report-".concat(_this1.filters.from_date, "-to-").concat(_this1.filters.to_date, ".csv"));
            ...
            case 2:
              _context1.p = 2;
              _t0 = _context1.v;
              console.error('Failed to export report:', _t0);
              sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                icon: 'error',
                title: 'Export Failed',
    ...
    openPrintModal: function openPrintModal(sale) {
        ...
        return _regenerator().w(function (_context10) {
          while (1) switch (_context10.p = _context10.n) {
            ...
            case 2:
              _context10.p = 2;
              _t1 = _context10.v;
              console.error('Failed to print receipt from modal:', _t1);
              sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                icon: 'error',
                title: 'Print Failed',
                text: 'Failed to generate receipt'
    ...
    generateDetailedReceiptHtml: function generateDetailedReceiptHtml(sale) {
      ...
      var total = (sale.total || 0).toFixed(2);
      var date = this.formatDate(sale.created_at);
      var paymentMethod = sale.payment_method || 'GCash';
    ...
    generateInvoiceHtml: function generateInvoiceHtml(sale) {
      ...
      var date = this.formatDate(sale.created_at);
      var paymentMethod = sale.payment_method || 'GCash';
      return "<!doctype html><html><head><meta charset=\"utf-8\"><title>Invoice #".concat(sale.id, "</title>\n        <style>body{font-family:Arial,sans-serif;padding:16px;} h2{margin:0 0 8px;} table{width:100%;border-collapse:collapse;} td,th{padding:6px;border-bottom:1px solid #eee;} th{text-align:left;} .tot{font-weight:bold;}</style>\n      </head><body>\n        <h2>Invoice #").concat(sale.id, "</h2>\n        <div>Date: ").concat(date, "</div>\n        <hr/>\n        <table>\n          <thead><tr><th>Item</th><th style=\"text-align:right;\">Qty</th><th style=\"text-align:right;\">Price</th><th style=\"text-align:right;\">Total</th></tr></thead>\n          <tbody>").concat(lines, "</tbody>\n          <tfoot><tr><td colspan=\"3\" class=\"tot\" style=\"text-align:right;\">Grand Total</td><td class=\"tot\" style=\"text-align:right;\">\u20B1").concat(total, "</td></tr></tfoot>\n        </table>\n        <p>Payment Method: ").concat(paymentMethod, "</p>\n      </body></html>");
    }
  }
});
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Reports.vue?vue&type=template&id=6c52f8b8&scoped=true":
/*!************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Reports.vue?vue&type=template&id=6c52f8b8&scoped=true ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("b-container", {
    ...
    staticClass: "mb-0"
  }, [_vm._v("Sales Reports")])]), _vm._v(" "), _c("b-col", {
    attrs: {
      cols: "auto"
    }
  }, [_c("b-button", {
    ...
    on: {
      submit: function submit($event) {
        ...
        return _vm.handleFilterSubmit.apply(null, arguments);
      }
    }
  }, [_c("b-row", {
    staticClass: "g-3"
  ...
  }, [_vm._v("Loading report data...")])]) : _vm._e(), _vm._v(" "), !_vm.isLoading ? _c("div", [_c("b-row", {
    staticClass: "mb-3"
  }, [_c("b-col", {
    attrs: {
      md: "3"
  ...
  }, [_c("h4", [_vm._v(_vm._s(_vm.summary.total_sales || 0))]), _vm._v(" "), _c("small", [_vm._v("Total Sales")])])], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "3"
    }
  }, [_c("b-card", {
  ...
  }, [_c("h4", [_vm._v("₱" + _vm._s((_vm.summary.total_revenue || 0).toFixed(2)))]), _vm._v(" "), _c("small", [_vm._v("Total Revenue")])])], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "3"
    }
  }, [_c("b-card", {
  ...
  }, [_c("h4", [_vm._v(_vm._s(_vm.summary.total_items || 0))]), _vm._v(" "), _c("small", [_vm._v("Items Sold")])])], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "3"
    }
  }, [_c("b-card", {
  ...
  }, [_c("h4", [_vm._v("₱" + _vm._s((_vm.summary.average_sale || 0).toFixed(2)))]), _vm._v(" "), _c("small", [_vm._v("Average Sale")])])], 1)], 1), _vm._v(" "), _c("b-row", {
    staticClass: "mb-3"
  }, [_c("b-col", {
    attrs: {
      md: "6"
    ...
    staticClass: "card-title"
  }, [_vm._v("Sales by Day")]), _vm._v(" "), _c("canvas", {
    ref: "salesByDayChart"
  })])], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "6"
    ...
    staticClass: "card-title"
  }, [_vm._v("Sales by Category")]), _vm._v(" "), _c("canvas", {
    ...
    staticClass: "card-title"
  }, [_vm._v("Top Selling Products")]), _vm._v(" "), _c("b-table", {
    attrs: {
      small: "",
      hover: "",
      items: _vm.topProducts,
      fields: _vm.topProductFields,
      responsive: "sm",
      striped: ""
    },
    scopedSlots: _vm._u([{
    ...
    staticClass: "card-title"
  }, [_vm._v("Recent Sales")]), _vm._v(" "), _c("b-table", {
    attrs: {
      small: "",
      hover: "",
      items: _vm.recentSales,
      fields: _vm.recentSalesFields,
      responsive: "sm",
      striped: ""
    },
    scopedSlots: _vm._u([{
        ...
        return [_c("b-button", {
          ...
          on: {
            click: function click($event) {
              return _vm.viewSaleDetails(item.id);
            }
          }
        }, [_c("i", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn() {
        return [_c("div", {
          ...
          staticClass: "fas fa-chart-line fa-3x mb-3"
  ...
  }, [_vm.selectedSale ? _c("div", [_c("b-row", [_c("b-col", {
    attrs: {
      sm: "6"
    }
  }, [_c("strong", [_vm._v("Sale ID:")]), _c("br"), _vm._v("\n          #" + _vm._s(_vm.selectedSale.id) + "\n        ")]), _vm._v(" "), _c("b-col", {
    attrs: {
      sm: "6"
    }
  }, [_c("strong", [_vm._v("Date:")]), _c("br"), _vm._v("\n          " + _vm._s(_vm.formatDate(_vm.selectedSale.created_at)) + "\n        ")])], 1), _vm._v(" "), _c("hr"), _vm._v(" "), _c("b-row", [_c("b-col", {
    attrs: {
      sm: "6"
    }
  }, [_c("strong", [_vm._v("Total Amount:")]), _c("br"), _vm._v("\n          ₱" + _vm._s((_vm.selectedSale.total || 0).toFixed(2)) + "\n        ")]), _vm._v(" "), _c("b-col", {
    attrs: {
      sm: "6"
    }
  }, [_c("strong", [_vm._v("Payment Method:")]), _c("br"), _vm._v("\n          " + _vm._s(_vm.selectedSale.payment_method || "GCash") + "\n        ")])], 1), _vm._v(" "), _c("hr"), _vm._v(" "), _c("h6", [_vm._v("Items:")]), _vm._v(" "), _c("b-table", {
    attrs: {
      small: "",
      items: _vm.selectedSale.sale_items || [],
      fields: _vm.saleItemFields,
      responsive: "sm"
    },
    scopedSlots: _vm._u([{
      key: "cell(unit_price)",
    ...
    on: {
      click: function click($event) {
        return _vm.openPrintModal(_vm.selectedSale);
      }
    }
  }, [_c("i", {
    staticClass: "fas fa-print"
  ...
  }, [_vm.selectedSaleForPrint ? _c("div", [_c("h6", {
    staticClass: "mb-3"
  }, [_vm._v("Print Options for Sale #" + _vm._s(_vm.selectedSaleForPrint.id))]), _vm._v(" "), _c("b-form", {
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.printReceiptFromModal.apply(null, arguments);
      }
    }
  }, [_c("b-form-group", {
    attrs: {
    ...
    attrs: {
      options: _vm.printTypeOptions,
      required: ""
    },
    model: {
      value: _vm.printOptions.type,
      callback: function callback($$v) {
        _vm.$set(_vm.printOptions, "type", $$v);
      },
      expression: "printOptions.type"
    }
    ...
    model: {
      value: _vm.printOptions.includes,
      callback: function callback($$v) {
        _vm.$set(_vm.printOptions, "includes", $$v);
      },
      expression: "printOptions.includes"
    }
  }, [_c("b-form-checkbox", {
    attrs: {
      value: "header"
    }
  }, [_vm._v("Header & Logo")]), _vm._v(" "), _c("b-form-checkbox", {
    attrs: {
      value: "items"
    }
  }, [_vm._v("Item Details")]), _vm._v(" "), _c("b-form-checkbox", {
    attrs: {
      value: "summary"
    }
  }, [_vm._v("Summary & Total")]), _vm._v(" "), _c("b-form-checkbox", {
    attrs: {
      value: "footer"
    }
  }, [_vm._v("Footer & Terms")])], 1)], 1), _vm._v(" "), _c("b-form-group", {
    attrs: {
      label: "Paper Size"
    }
  }, [_c("b-form-select", {
    attrs: {
      options: _vm.paperSizeOptions
    },
    model: {
      value: _vm.printOptions.paperSize,
      callback: function callback($$v) {
        _vm.$set(_vm.printOptions, "paperSize", $$v);
      },
      expression: "printOptions.paperSize"
    }
  })], 1), _vm._v(" "), _c("div", {
    staticClass: "d-flex justify-content-end gap-2 mt-3"
  }, [_c("b-button", {
    ...
    on: {
      click: function click($event) {
        return _vm.$bvModal.hide("print-modal");
      }
    }
  }, [_vm._v("\n            Cancel\n          ")]), _vm._v(" "), _c("b-button", {
    attrs: {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Reports.vue?vue&type=style&index=0&id=6c52f8b8&scoped=true&lang=css":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Reports.vue?vue&type=style&index=0&id=6c52f8b8&scoped=true&lang=css ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Reports_vue_vue_type_style_index_0_id_6c52f8b8_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Reports.vue?vue&type=style&index=0&id=6c52f8b8&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Reports.vue?vue&type=style&index=0&id=6c52f8b8&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Reports_vue_vue_type_style_index_0_id_6c52f8b8_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Reports_vue_vue_type_template_id_6c52f8b8_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Reports.vue?vue&type=template&id=6c52f8b8&scoped=true */ "./resources/js/components/Reports.vue?vue&type=template&id=6c52f8b8&scoped=true");
...
/* harmony import */ var _Reports_vue_vue_type_style_index_0_id_6c52f8b8_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Reports.vue?vue&type=style&index=0&id=6c52f8b8&scoped=true&lang=css */ "./resources/js/components/Reports.vue?vue&type=style&index=0&id=6c52f8b8&scoped=true&lang=css");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _Reports_vue_vue_type_template_id_6c52f8b8_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _Reports_vue_vue_type_template_id_6c52f8b8_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "6c52f8b8",
  null
...
/***/ "./resources/js/components/Reports.vue?vue&type=style&index=0&id=6c52f8b8&scoped=true&lang=css":
/*!*****************************************************************************************************!*\
  !*** ./resources/js/components/Reports.vue?vue&type=style&index=0&id=6c52f8b8&scoped=true&lang=css ***!
  \*****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Reports_vue_vue_type_style_index_0_id_6c52f8b8_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Reports.vue?vue&type=style&index=0&id=6c52f8b8&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Reports.vue?vue&type=style&index=0&id=6c52f8b8&scoped=true&lang=css");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Reports_vue_vue_type_template_id_6c52f8b8_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Reports_vue_vue_type_template_id_6c52f8b8_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Reports_vue_vue_type_template_id_6c52f8b8_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Reports.vue?vue&type=template&id=6c52f8b8&scoped=true */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Reports.vue?vue&type=template&id=6c52f8b8&scoped=true");
